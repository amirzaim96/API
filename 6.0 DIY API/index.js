...
app.get('/random/', (req, res) => {
  let randJoke = jokes[Math.floor(Math.random() * jokes.length)]
  res.json(randJoke);
})
...
app.get('/jokes/:id', (req, res) => {
  ...
  let foundJoke = jokes.find((joke) => joke.id === num)
  res.json(foundJoke);
})
...
app.get('/filter', (req, res) => {
  ...
  let foundJoke = jokes.filter((joke) => joke.jokeType === type)
  res.json(foundJoke);
})
...
app.put('/jokes/:id', (req, res) => {
  ...
  // let searchIndex = jokes.findIndex((joke) => joke.id === num);
  jokes[num] = newJoke;
  res.json(newJoke);
...
app.patch('/jokes/:id', (req, res) => {
  let num = parseInt(req.params.id);
  let existingJoke = jokes.find((joke) => joke.id === num)
  let patchJoke = {
    id: num,
